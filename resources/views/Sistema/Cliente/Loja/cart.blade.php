                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarContainer">
                            ...
                            <ul class="nav navbar-nav float-right nav-top">
                                <li class="active">
                                    <a id="cart-link" href="{{ route('cart', ['produto' => $produto->id]) }}"
                                        class="trsn nav-link" title="View/Edit Cart">
                                        <i class="fas fa-shopping-cart"></i>
                                        <span id="nav-bar-cart"><span class="cart-size">1</span> Product(s)
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td class="text-center mob-hide">
                                    <a href="/keyboarded-tablet" class="trsn" title="{{ $produto->nome }}">
                                ...
                                <td clas="text-right"> <a href="/cart/remove_product/149506641"
                                        class="cart-product-remove" title="Remove Product"><i
                ...
                <div class="row">
                    ...
                    <div class="col-12 cart-totals">
                        ...
                        <div class="text-center cart-actions">
                            <a href="https://bootstrap.jumpseller.com/checkout?token=270b9e33d86314c77a776680ce3276b2"
                                class="btn btn-primary btn-block" title="Seguir para o pagamento">Seguir para o pagamento</a>
                            <a href="{{route('loja')}}" class="btn btn-link btn-block" title="&larr; Continuar Comprando">&larr;
