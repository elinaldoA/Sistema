            ...
            <div class="card-header py-3">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover text-center">
                        ...
                        @forelse($receitas as $d)
                        <tr>
                            <td></td>
                            <td>
                                <a class="btn btn-outline-primary" href="{{route('receita.editar', ['receita' => $r->id])}}"><i class="fa fa-edit"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger btn-ok" href="{{route('receita.excluir', ['receita' => $r->id])}}">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
