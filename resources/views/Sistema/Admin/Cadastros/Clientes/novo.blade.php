...
<div class="col">
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('cliente.create') }}" class="clientes">
                    @csrf
                    <div class="pl-lg-12">
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="genero_id">Sexo<span class="small text-danger"> * </span></label>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="foto">Foto<span class="small text-danger"> * </span></label>
                                    <input type="file" id="foto" name="foto" class="blue form-control" required>
                                </div>
                            </div>
                            <div class="col-lg-1">
                                <div class="form-group focused">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <a href="{{route('clientes')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> Voltar</a>
                        </div>
                    </div>
                </form>
