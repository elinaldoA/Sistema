...
<div class="col">
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('empresa.editar', ['empresa' => $empresa, 'endereco' => $endereco]) }}" class="empresas">
                                ...
                                <div class="row">
                                    <div class="col-lg-1">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="active">Status<span class="small text-danger"> * </span></label>
                                            <input type="checkbox" name="active" id="active" value="{{$empresa->active}}" class="blue form-control"
                                            @if( ($empresa->active == 0 && old('active') && old('first_time'))
                                            || ($empresa->active && old('active') == null && old('first_time') == null)
                                            || ($empresa->active && old('active') && old('first_time') ) )
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="cpf">Cnpj<span class="small text-danger"> * </span></label>
                                    ...
                                    <div class="col">
                                        <div class="form-group focused">
                                            <label class="form-control-label" for="description">Descrição<span class="small text-danger"> * </span></label>
                                            <textarea class="form-control form-control-user" name="description" id="description" required cols="5" rows="5">{{$empresa->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="rua" class="form-control" name="rua" placeholder="Rua, Logradouro, Avenida, Travessa ..." value="{{$endereco->rua}}">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="referencia">Ponto de referência<span class="small text-danger">*</span></label>
                                        <input type="text" id="complemento" class="form-control" name="complemento" placeholder="Perto de...">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="numero">Número<span class="small text-danger"> * </span></label>
                                        <input type="text" id="numero" class="form-control" name="numero" placeholder="1234" onkeyup="somenteNumeros(this);" maxlength="4">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="cep" class="form-control" name="cep" placeholder="Números" onkeypress="mascara(this,'#####-###')" maxlength="12">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="cidade">Cidade<span class="small text-danger">*</span></label>
                                        <input type="text" id="cidade" class="form-control" name="cidade" placeholder="Sua cidade">
                                    </div>
                                </div>
                                <div class="col-lg-2">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="estado">Estado<span class="small text-danger"> * </span></label>
                                        <input type="text" id="estado" class="form-control" name="estado" placeholder="Es" maxlength="2">
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="pais">País<span class="small text-danger"> * </span></label>
                                        <input type="text" id="pais" class="form-control" name="pais" placeholder="Brasil">
                                    </div>
                                </div>
                            </div>
                        </div>
