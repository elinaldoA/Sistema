...
<div class="col">
    <div class="col-lg-12 order-lg-1">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('empresa.show', ['empresa' => $empresa->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="cep" class="form-control" name="cep" placeholder="Números" onkeypress="mascara(this,'#####-###')" maxlength="12" required>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group focused">
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                <a href="{{route('empresas')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i></a>
                            </div>
                        </div>
                    </div>
                </form>
