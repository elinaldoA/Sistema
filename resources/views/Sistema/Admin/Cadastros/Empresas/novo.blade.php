                                ...
                                <div class="row">
                                    <div class="col-lg-1">
                                        <div class="form-group focused">
                                            ...
                                            <input type="checkbox" id="active" name="active" class="blue form-control" value="1" @if(old('active')) checked="checked" @endif required>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                        <div class="form-group focused">
                                    ...
                                    <div class="col">
                                        <div class="form-group focused">
                                            ...
                                            <textarea class="form-control form-control-user" name="description" id="description" required cols="5" rows="5"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4" hidden="true">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="empresa_id" class="form-control" name="empresa_id" value="1">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pl-lg-2">
                        <div class="row">
                            <div class="col">
                                ...
                                <a href="{{route('empresas')}}" class="btn btn-outline-primary"><i class="fas fa-angle-double-left"></i> Voltar</a>
                            </div>
                        </div>
                    </div>
                </form>
