                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover text-center">
                        ...
                        <tr>
                            <td>{{$p->name}}</td>
                            <td>
                                <a class="btn btn-outline-primary" href="{{route('plano.editar', ['plano' => $p->id])}}"><i class="fa fa-edit"></i></a>
                                <a class="btn btn-outline-primary" href="{{route('plano.show', ['plano' => $p->id])}}"><i class="fa fa-eye"></i></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger btn-ok" href="{{route('plano.excluir', ['plano' => $p->id])}}">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<script>
    ...
    $('.delete').attr('href', 'plano.excluir?id=' + id);
