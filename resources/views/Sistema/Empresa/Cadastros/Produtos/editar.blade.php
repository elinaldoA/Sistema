                            ...
                            <div class="col-lg-1">
                                <div class="form-group focused">
                                    <label class="form-control-label" for="destaque">Destaque</label>
                                        ...
                                        @if( ($produto->destaque == 0 && old('destaque') && old('first_time'))
                                        || ($produto->destaque && old('destaque') == null && old('first_time') == null)
                                        || ($produto->destaque && old('destaque') && old('first_time') ) )
                                            checked="checked"
                                        @endif
                                         >
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a class="btn btn-danger btn-ok" href="{{route('produto.excluir', ['produto' => $produto->id])}}">Visualizar</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
