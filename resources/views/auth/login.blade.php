    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="p-5">
                ...
                <form method="POST" action="{{ route('sistema.admin.login') }}" class="user">
                ...
                <div class="text-center">
                    <a class="small" href="{{ route('sistema.admin.password.request') }}">
                        {{ __('Recuperar senha?') }}
                    </a>
                </div>
                @endif
                ...
                <div class="text-center">
                    <a class="small" href="{{ route('sistema.admin.register') }}">{{ __('Criar conta!') }}</a>
                </div>
                @endif
            </div>
        </div>
