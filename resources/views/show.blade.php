...
<head>
    ...
    <meta property="og:image"
        content="https://cdnx.jumpseller.com/bootstrap/image/1072447/resize/1200/1200?1614272621" />
    ...
    <meta property="og:description"
        content="Just getting going with your art? Transitioning from paper to computer-based work? The Bamboo Splash is a great way to explore your interests, with a premium feel of the pen tablet and everything you need to get started in the box.Start something fun! Sketch, draw, paint, all on your computer with the new Bamboo Splash. You'll work both digitall..." />
    <meta property="og:url" content="https://bootstrap.jumpseller.com/wacom-tablet" />
    ...
    <link rel="canonical" href="https://bootstrap.jumpseller.com/wacom-tablet">
...
<body>
                ...
                <form class="form-horizontal" action="{{ route('adicionar', ['produto' => $produto]) }}"
                    ...
                    <div class="form-group product-stock product-out-stock row hidden">
                        ...
                        <div class="col-sm-8 col-md-9">
                            ...
                            <a href="javascript:history.back()" class="btn btn-link btn-sm"
                                title="&larr; or Continue Shopping">&larr; or Continue Shopping</a>
                        </div>
                    </div>
                    <!-- Not Available -->
                    <div class="form-group product-stock product-unavailable row hidden">
                        ...
                        <div class="col-sm-8 col-md-9">
                            ...
                            <a href="/contact" class="btn btn-secondary btn-sm" title="Contact Us">Contato</a>
                            <a href="javascript:history.back()" class="btn btn-link btn-sm"
                                title="&larr; or Continue Shopping">&larr; or Continuar comprando</a>
                        </div>
                    </div>
                    ...
                    <div id="product-sharing" class="row">
                        ...
                        <ul class="list-inline social-networks col-sm-9 col-md-9">
                            ...
                            <li class="list-inline-item">
                                <a class="has-tip tip-top radius button tiny button-tumblr trsn"
    ...
    <script>
        function checkOutOfStock(productInfo) {
            ...
            const variants = product.filter((entry) => entry.variant.stock == 0 && !entry.variant.stock_unlimited && entry
                .values.filter((val) => values.includes(val.value.id)).length == values.length - 1)

            if (productInfo.stock == 0 && !productInfo.stock_unlimited) variants.push(product.find((entry) => entry.variant
                .id == productInfo.id))
            ...
            variants.forEach((variant) => {
                ...
                ids.forEach((id) => {
                    $('.variants option[value="' + id + '"]')?.html($('.variants option[value="' + id +
                        '"]')?.html()?.replace(outOfStock, ''));
                    $('.variants option[value="' + id + '"], .variants input[value="' + id + '"]').addClass(
                        'disabled');
                    $('.variants option[value="' + id + '"]').html($('.variants option[value="' + id + '"]')
                        .html() + outOfStock);
                })
        ...
        var callbackFunction = function(event, productInfo) {
            ...
            if (!$.isEmptyObject(productInfo)) {
                ...
                if (productInfo.image != '') {
                    $('#product-carousel .carousel-inner .active img').attr('src', productInfo.image).attr('srcset',
                        productInfo.image);
                }
                ...
                //update stock
                if ((productInfo.stock == 0 && productInfo.stock_unlimited == false) || productInfo.status ==
                    'not-available') {
                    ...
                    if (productInfo.stock_unlimited == false && productInfo.stock > 0) {
                        $('#stock').html(
                            ' <label class="col-sm-3 col-md-3 form-control-label">Stock:</label><div class="col-sm-8 col-md-9"><span class="product-form-stock">' +
        ...
        function setSelectedVariant(values) {
            for (const {
                ...
                $(`.variants *[id="${option}"] *[value="${id}"]`).each(function() {
                    $(this).is("input") ? $(this).prop('checked', true).trigger('change') : $(this).prop('selected',
                        true).trigger('change')
                });
            }
        }
        ...
        function selectInitialStock() {
            ...
            const preferred = +'';
            if (preferred > 0) return setSelectedVariant(productInfo.find((product) => product.variant.id == preferred)
                .values);
        ...
        function checkCustomFields(custom_fields) {
            ...
            if (Object.keys(custom_fields).length != 0) {
                ...
                $('.product-custom_field').each(function() {
                    const custom_field_values = $(this).find(
                        '.product-custom_field_value.visible_custom_field_value').length;
                    if (custom_field_values > 1) {
                        $(this).find('.product-custom_field_value.visible_custom_field_value').each(function(
                            index) {
